...
class TripRequestResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $trip_request = [
            ...
            'carpool_ride_location' => $this->carpool_ride_location ? [
                'longitude' => $this->carpool_ride_location->longitude,
                'latitude' => $this->carpool_ride_location->latitude
            ] : null,
          'distance' => $this->distance ?? 0,
          'distance_text' => $this->distance ? round($this->distance, 2).' km' : '0.00 km',
          'duration' => $this->duration ?? 0,
          'duration_sec' => $this->duration_sec ?? 0,
          'drive_mode' => $this->drive_mode ?? 'DRIVE',
          'encoded_polyline' => $this->encoded_polyline ?? '',
			...
			'parcel_complete_time' => $this->tripStatus?->completed,
