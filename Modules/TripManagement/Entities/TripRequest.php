...
{
    use HasFactory, HasUuid, SoftDeletes, HasSpatial;
    ...
    protected $casts = [
        ...
        'carpool_ride_location' => Point::class
    ];
 ...
 //     public function carpoolRoute()
  //  {
   //     return $this->hasOne(CarpoolRoute::class, 'trip_request_id');
   // }
    ...
    public function carpoolRoute()
{
    ...
    public function carpoolPassengers()
    {
        return $this->hasMany(CarpoolPassenger::class, 'trip_request_id');
    }
