                                        ...
                                        <table class="table table-borderless align-middle table-hover">
                                            ...
                                            @forelse($drivers as $key => $driver)
                                                <tr id="hide-row-{{ $driver->id }}" class="record-row">
                                                    ...
                                                    <td class="name">
                                                        <a href="{{ isset($driver->id) && $driver->id ? route('admin.driver.show', ['id' => $driver->id]) : '#' }}"
                                                        ...
                                                        <div
                                                            ...
                                                            @can('user_log')
                                                                <a type="button"
                                                                   ...
                                                                   href="{{ isset($driver->id) && $driver->id ? route('admin.driver.log') . '?id=' . $driver->id : '#' }}">
                                                                    <i class="bi bi-clock-fill"></i>
                                                                </a>
                                                            @endcan
                                                            @can('user_edit')
                                                                <a href="{{ isset($driver->id) && $driver->id ? route('admin.driver.edit', ['id' => $driver->id]) : '#' }}"
                                                            ...
                                                            @can('user_delete')
                                                                    @if(count($driver->getDriverLastTrip())!=0|| ($driver?->userAccount?->payable_balance>0 || $driver?->userAccount?->pending_balance>0 || $driver?->userAccount?->receivable_balance>0))
                                                                        ...
                                                                        <form
                                                                            action="{{ isset($driver->id) && $driver->id ? route('admin.driver.delete', ['id' => $driver->id]) : '#' }}"
