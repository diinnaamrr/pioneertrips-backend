            ...
            <div class="d-flex mb-4">
                <ul class="nav nav--tabs p-1 rounded bg-white" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{ isset($commonData['driver']->id) && $commonData['driver']->id ? route('admin.driver.show', ['id' => $commonData['driver']->id, 'tab' => 'overview']) : '#' }}"
                            class="nav-link {{ $commonData['tab'] == 'overview' ? 'active' : '' }}">{{ translate('overview') }}</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ $commonData['tab'] == 'vehicle' ? 'active' : '' }}"
                            href="{{ isset($commonData['driver']->id) && $commonData['driver']->id ? route('admin.driver.show', ['id' => $commonData['driver']->id, 'tab' => 'vehicle']) : '#' }}"
                            tabindex="-1">{{ translate('vehicle') }}</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="{{ isset($commonData['driver']->id) && $commonData['driver']->id ? route('admin.driver.show', ['id' => $commonData['driver']->id, 'tab' => 'trips']) : '#' }}"
                            class="nav-link {{ $commonData['tab'] == 'trips' ? 'active' : '' }}"
                            tabindex="-1">{{ translate('trips') }}</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="{{ isset($commonData['driver']->id) && $commonData['driver']->id ? route('admin.driver.show', ['id' => $commonData['driver']->id, 'tab' => 'transaction']) : '#' }}"
                            class="nav-link {{ $commonData['tab'] == 'transaction' ? 'active' : '' }}" role="tab"
                            tabindex="-1">{{translate("Transaction")}}</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="{{ isset($commonData['driver']->id) && $commonData['driver']->id ? route('admin.driver.show', ['id' => $commonData['driver']->id, 'tab' => 'review', 'reviewed_by' => 'customer']) : '#' }}"
