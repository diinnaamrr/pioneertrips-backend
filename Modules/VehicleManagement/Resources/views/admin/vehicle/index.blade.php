                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($vehicles as $key => $vehicle)
                                                    <tr id="hide-row-{{ $vehicle->id }}" class="record-row">
                                                        ...
                                                        <td class="sl"><a href="{{$vehicle?->driver?->id ? route('admin.driver.show', ['id' => $vehicle?->driver?->id]) : ""}}">{{ $vehicle?->driver?->full_name ?? ($vehicle?->driver?->first_name? $vehicle?->driver?->first_name .' '. $vehicle?->driver?->last_name :"N/A") }}</a></td>
                                                        <td class="sl">
                                                        ...
                                                        <td class="text-capitalize owner">{{ translate($vehicle->ownership) }}</td>
                                                        <td class="text-capitalize vehicle-features">
                                                            ...
                                                            <br> {{ translate('fuel') }}: {{ translate($vehicle->fuel_type) }}
                                                        </td>
                                                        @can('vehicle_edit')
                                                            <td class="status">
