<?php return array (
  ...
  'Zero Commission life time' => 'Zero Commission life time',
  'Firebase Console' => 'Firebase Console',
  ...
  'Earn Money from UR-Turn' => 'Earn Money from UR-Turn',
  'No surge  Zero Commissions UT-turn Fair rides & prices' => 'No surge  Zero Commissions UT-turn Fair rides & prices',
  'It’s Time to Change The Ride Hailing Experience' => 'It’s Time to Change The Ride Hailing Experience',
  ...
  'UR-Turn technology company whose mission is to reimagine the way the world moves for the better. Our technology enables us to create and operate multisided platforms that connect custoةers seeking trips with independent ride providers and other types of transportation.' => 'UR-Turn technology company whose mission is to reimagine the way the world moves for the better. Our technology enables us to create and operate multisided platforms that connect custoةers seeking trips with independent ride providers and other types of transportation.',
  ...
  'You got a new message from Seif Assem' => 'You got a new message from Seif Assem',
  '21.58 payment successful on this trip by cash.' => '21.58 payment successful on this trip by cash.',
  ...
  'Admin has added 1000 to your wallet' => 'Admin has added 1000 to your wallet',
  ...
  'lowest Commission life time' => 'Lowest Commission life time',
  'Earn Money' => 'Earn Money',
  'hey hey' => 'Hey hey',
  'International standards' => 'International standards',
  'total_Download' => 'Total Download',
  'Egyptian rides' => 'Egyptian rides',
  'EG' => 'EG',
  'welcome to' => 'Welcome to',
  'Drivo technology company whose mission is to reimagine the way the world moves for the better. Our technology enables us to create and operate multisided platforms that connect custoةers seeking trips with independent ride providers and other types of transportation.' => 'Drivo technology company whose mission is to reimagine the way the world moves for the better. Our technology enables us to create and operate multisided platforms that connect custoةers seeking trips with independent ride providers and other types of transportation.',
  ...
  'The ride type field is required.' => 'The ride type field is required.',
  'The selected trip request id is invalid.' => 'The selected trip request id is invalid.',
  ...
  'The selected carpool passenger id is invalid.' => 'The selected carpool passenger id is invalid.',
  'The carpool route id field is required.' => 'The carpool route id field is required.',
  'The price trip field is required.' => 'The price trip field is required.',
  'The start lat field is required.' => 'The start lat field is required.',
  'The start lng field is required.' => 'The start lng field is required.',
  'The end lat field is required.' => 'The end lat field is required.',
  'The end lng field is required.' => 'The end lng field is required.',
  'The price field is required.' => 'The price field is required.',
  'The start time does not match the format Y-m-d H:i:s.' => 'The start time does not match the format Y-m-d H:i:s.',
  'The selected allowed gender is invalid.' => 'The selected allowed gender is invalid.',
  'The route id field is required.' => 'The route id field is required.',
  ...
  'Admin just updated system terms and conditions.' => 'Admin just updated system terms and conditions.',
  'Can not go to offline during running trip' => 'Can not go to offline during running trip',
  'Hatly' => 'Hatly',
  'start Earning Money now with drivo' => 'Start Earning Money now with drivo',
  'Lowest commission' => 'Lowest commission',
  'start Earning Money now with' => 'Start Earning Money now with',
  'Admin has added 100 to your wallet' => 'Admin has added 100 to your wallet',
  'Congratulations a 10 has been added to your wallet' => 'Congratulations a 10 has been added to your wallet',
  'Congratulations a 1 has been added to your wallet' => 'Congratulations a 1 has been added to your wallet',
  '✨ Congratulations a 1 has been added to your wallet 🥳 .' => '✨ Congratulations a 1 has been added to your wallet 🥳 .',
  '✨ Congratulations a 1 EGP has been added to your wallet balance 🥳 .' => '✨ Congratulations a 1 EGP has been added to your wallet balance 🥳 .',
  'The selected vehicle id is invalid.' => 'The selected vehicle id is invalid.',
  'Your access has been denied' => 'Your access has been denied',
  'Another driver already accepted the trip request.' => 'Another driver already accepted the trip request.',
  'A Driver has accepted your trip request.' => 'A Driver has accepted your trip request.',
  'Your trip has started.' => 'Your trip has started.',
  'You got a new message from seif assem' => 'You got a new message from seif assem',
  'You got a new message from ahmed osman' => 'You got a new message from ahmed osman',
  'Trip request is paused.' => 'Trip request is paused.',
  'Trip request is resumed.' => 'Trip request is resumed.',
  'Your trip is completed' => 'Your trip is completed',
  '44.19 payment successful on this trip by cash.' => '44.19 payment successful on this trip by cash.',
  '44.89 payment successful on this trip by cash.' => '44.89 payment successful on this trip by cash.',
  'earning_invoice' => 'Earning invoice',
  'Admin collected cash!' => 'Admin collected cash!',
  'Admin cash collect from driver.' => 'Admin cash collect from driver.',
  'Your vehicle is now approved by Drivo ✅ .' => 'Your vehicle is now approved by Drivo ✅ .',
  'Driver not found' => 'Driver not found',
  'Ready   You have a new ride request' => 'Ready   You have a new ride request',
  '{driverName} has accepted your request.' => '{driverName} has accepted your request.',
  '10.01 payment successful on this trip by cash.' => '10.01 payment successful on this trip by cash.',
  'The selected carpool route id is invalid.' => 'The selected carpool route id is invalid.',
  ...
  'The dropoff lat field is required.' => 'The dropoff lat field is required.',
  'The dropoff lng field is required.' => 'The dropoff lng field is required.',
  'The day field is required.' => 'The day field is required.',
  'The profile image must be an image.' => 'The profile image must be an image.',
  'The allowed age max may not be greater than 99.' => 'The allowed age max may not be greater than 99.',
  'The identity_images.1 may not be greater than 10000 kilobytes.' => 'The identity images.1 may not be greater than 10000 kilobytes.',
  'The identity_images.0 may not be greater than 10000 kilobytes.' => 'The identity images.0 may not be greater than 10000 kilobytes.',
  '15.7 payment successful on this trip by cash.' => '15.7 payment successful on this trip by cash.',
  ...
  'The selected ride type is invalid.' => 'The selected ride type is invalid.',
  'You have already created a vehicle.' => 'You have already created a vehicle.',
  '282.2 payment successful on this trip by cash.' => '282.2 payment successful on this trip by cash.',
  'You got a new message from osmaa gamil' => 'You got a new message from osmaa gamil',
  'Your identity image has been rejected during our review process.' => 'Your identity image has been rejected during our review process.',
  'iujkk' => 'Iujkk',
  'uyuyf' => 'Uyuyf',
  'ghg' => 'Ghg',
  'test' => 'Test',
  'test custom notifcation for customers' => 'Test custom notifcation for customers',
  'welcome to drivo   wish you a great day' => 'Welcome to drivo   wish you a great day',
  ...
  'please update your profile details .' => 'Please update your profile details .',
  'welcome to drivo .' => 'Welcome to drivo .',
  'The phone format is invalid.' => 'The phone format is invalid.',
  'congratulations   We have approved your registration. You can login now 🤩!' => 'Congratulations   We have approved your registration. You can login now 🤩!',
  'ان لم يتم تفعيل الحساب الخاص بكم برجاء مراجعة بياناتكم لعدم اكتمالها. بسبب صور غير صحيحة او بيانات غير مكتملة . و لو تم قبول حسابك تجاهل هذه الرسالة ، شكرا' => 'ان لم يتم تفعيل الحساب الخاص بكم برجاء مراجعة بياناتكم لعدم اكتمالها. بسبب صور غير صحيحة او بيانات غير مكتملة . و لو تم قبول حسابك تجاهل هذه الرسالة ، شكرا',
  'برجاء ارسال كل المستندات المطلوبة من حيث البطاقة الشخصية و الرخصة الخاصة بالسيارة عن طريق شات الدعم الفني داخل التطبيق ليتم اكمال الموافقة' => 'برجاء ارسال كل المستندات المطلوبة من حيث البطاقة الشخصية و الرخصة الخاصة بالسيارة عن طريق شات الدعم الفني داخل التطبيق ليتم اكمال الموافقة',
  'Driver has accepted your request.' => 'Driver has accepted your request.',
  'You got a new message from Magdy Abdo' => 'You got a new message from Magdy Abdo',
  'welcome to the game changer app   we will be ready to accept your rides in few days .. stay tuned .' => 'Welcome to the game changer app   we will be ready to accept your rides in few days .. stay tuned .',
  'SEARCH' => 'SEARCH',
  'بنحب نفكر الكباتن ان في الخريطة في الاطبيق في شكل سهم اسود علي الخريطة بيفتح معاك خدمات جوجل مابس لو حبيت تشغل عليه اللوكيشن و ان الرحلات هتبدا تسغيلها من الاسبوع القادم لان ده مازال ضمن اسبوع التسجيلات 🤩🚘✅ يلا اجهز يا كابتن' => 'بنحب نفكر الكباتن ان في الخريطة في الاطبيق في شكل سهم اسود علي الخريطة بيفتح معاك خدمات جوجل مابس لو حبيت تشغل عليه اللوكيشن و ان الرحلات هتبدا تسغيلها من الاسبوع القادم لان ده مازال ضمن اسبوع التسجيلات 🤩🚘✅ يلا اجهز يا كابتن',
  'تم قبول السيارة الخاصة بالتسجيل' => 'تم قبول السيارة الخاصة بالتسجيل',
  'برجا ارسال رخصة السيارة و البطاقة الشخصية علي شات الدعم الفني' => 'برجا ارسال رخصة السيارة و البطاقة الشخصية علي شات الدعم الفني',
  'The profile image may not be greater than 10000 kilobytes.' => 'The profile image may not be greater than 10000 kilobytes.',
  'this a test message' => 'This a test message',
  'TEST NOTY' => 'TEST NOTY',
  'The fare field is required.' => 'The fare field is required.',
  'The seats count field is required.' => 'The seats count field is required.',
  'The current lng field is required.' => 'The current lng field is required.',
  'The current lat field is required.' => 'The current lat field is required.',
  'The destination coordinates field is required.' => 'The destination coordinates field is required.',
  'Your CarPool Ride has been created successflly' => 'Your CarPool Ride has been created successflly',
  'new_carpool' => 'New carpool',
  'New carpool' => 'New carpool',
  'Trip already cancelled' => 'Trip already cancelled',
  '58.83 payment successful on this trip by cash.' => '58.83 payment successful on this trip by cash.',
  ...
  'tawselty plus technology company whose mission is to reimagine the way the world moves for the better. Our technology enables us to create and operate multisided platforms that connect custoةers seeking trips with independent ride providers and other types of transportation.' => 'Tawselty plus technology company whose mission is to reimagine the way the world moves for the better. Our technology enables us to create and operate multisided platforms that connect custoةers seeking trips with independent ride providers and other types of transportation.',
  'wayak technology company whose mission is to reimagine the way the world moves for the better. Our technology enables us to create and operate multisided platforms that connect custoةers seeking trips with independent ride providers and other types of transportation.' => 'Wayak technology company whose mission is to reimagine the way the world moves for the better. Our technology enables us to create and operate multisided platforms that connect custoةers seeking trips with independent ride providers and other types of transportation.',
  'The has bags field must be true or false.' => 'The has bags field must be true or false.',
  'Download User App test' => 'Download User App test',
  22 => '22',
  2222 => '2222',
  'FAQ' => 'FAQ',
  ...
  'Hotline for Inquiries' => 'Hotline for Inquiries',
  ...
  'Inquiries' => 'Inquiries',
  'Hotline' => 'Hotline',
  'Wayak is your next-generation Egyptian ride-hailing and parcel delivery application  offering flexible pricing  driver selection  and secure payment options via Instapay and cards. We connect users and captains through a reliable and rewarding platform.' => 'Wayak is your next-generation Egyptian ride-hailing and parcel delivery application  offering flexible pricing  driver selection  and secure payment options via Instapay and cards. We connect users and captains through a reliable and rewarding platform.',
  'We typically respond within 24 hours' => 'We typically respond within 24 hours',
  'Email Support' => 'Email Support',
  'General Inquiries & Support' => 'General Inquiries & Support',
  'Call Our Hotline' => 'Call Our Hotline',
  'For any questions regarding this policy  please contact us via the Hotline: 15675.' => 'For any questions regarding this policy  please contact us via the Hotline: 15675.',
  'We do NOT store your full bank card numbers or Instapay passwords. Payments are processed securely via third-party providers (Instapay  Banks). We only retain payment confirmation tokens.' => 'We do NOT store your full bank card numbers or Instapay passwords. Payments are processed securely via third-party providers (Instapay  Banks). We only retain payment confirmation tokens.',
  'Our Main Office' => 'Our Main Office',
  'Our Journey' => 'Our Journey',
  'Leading the market with local payment solutions like Instapay integration and in-app wallets.' => 'Leading the market with local payment solutions like Instapay integration and in-app wallets.',
  'Local Innovation' => 'Local Innovation',
  'From OTP verification to real-time tracking  your safety is our top priority on every trip.' => 'From OTP verification to real-time tracking  your safety is our top priority on every trip.',
  'Uncompromised Safety' => 'Uncompromised Safety',
  'Empowering users and captains with negotiation tools and transparent pricing.' => 'Empowering users and captains with negotiation tools and transparent pricing.',
  'We are here to help you move forward. Reach out to the Wayak team.' => 'We are here to help you move forward. Reach out to the Wayak team.',
  'Fairness & Flexibility' => 'Fairness & Flexibility',
  'testimonials' => 'Testimonials',
  'ادفع بالطريقة التي تناسبك: محفظة التطبيق، بطاقتك البنكية، أو Instapay (عن طريق البريد الإلكتروني أو رقم المحفظة).' => 'ادفع بالطريقة التي تناسبك: محفظة التطبيق، بطاقتك البنكية، أو Instapay (عن طريق البريد الإلكتروني أو رقم المحفظة).',
  'دفع مرن ومحفظة ذكية' => 'دفع مرن ومحفظة ذكية',
  'تأكيد الركوب عبر كلمة مرور لمرة واحدة (OTP) لضمان أنك في السيارة الصحيحة، بالإضافة إلى تتبع مباشر للرحلة.' => 'تأكيد الركوب عبر كلمة مرور لمرة واحدة (OTP) لضمان أنك في السيارة الصحيحة، بالإضافة إلى تتبع مباشر للرحلة.',
  'أمان رحلتك أولويتنا (OTP)' => 'أمان رحلتك أولويتنا (OTP)',
  'لأننا نؤمن بالشفافية، يمكنك المساومة على سعر رحلتك واختيار العرض الأنسب، مع حد أدنى لضمان جودة الخدمة.' => 'لأننا نؤمن بالشفافية، يمكنك المساومة على سعر رحلتك واختيار العرض الأنسب، مع حد أدنى لضمان جودة الخدمة.',
  'ندعم Instapay، البطاقات البنكية، والمحفظة الداخلية للعملاء والسائقين على حد سواء.' => 'ندعم Instapay، البطاقات البنكية، والمحفظة الداخلية للعملاء والسائقين على حد سواء.',
  'نظام تأكيد الركوب عبر كلمة مرور لمرة واحدة (OTP) لسلامتك، بالإضافة إلى التتبع المباشر.' => 'نظام تأكيد الركوب عبر كلمة مرور لمرة واحدة (OTP) لسلامتك، بالإضافة إلى التتبع المباشر.',
  'لك مطلق الحرية في المساومة على سعر رحلتك واختيار العرض الأنسب لك، لضمان أعلى توفير.' => 'لك مطلق الحرية في المساومة على سعر رحلتك واختيار العرض الأنسب لك، لضمان أعلى توفير.',
  'حدد سعرك وتفاوض!' => 'حدد سعرك وتفاوض!',
  'وياك الحل الأمثل لتنقلاتك وشحناتك في مصر. يمنحك القوة لتختار السعر، مع أحدث طرق الدفع.' => 'وياك الحل الأمثل لتنقلاتك وشحناتك في مصر. يمنحك القوة لتختار السعر، مع أحدث طرق الدفع.',
  'Wayak نقلة نوعية في عالم التوصيل مع' => 'Wayak نقلة نوعية في عالم التوصيل مع',
  'Download Wayak Now' => 'Download Wayak Now',
