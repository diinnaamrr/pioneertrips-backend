...
if (!function_exists('tripRequestUpdate'))
{
    function tripRequestUpdate($data)
    {
        ...
        sendDeviceNotification(
            ...
            description: textVariableDataFormat(value: translate($push['description']),paidAmount: $trip->paid_fare,methodName: $trip->payment_method),
            status: $push['status'],
        ...
        if ($trip->tips > 0)
        {
            ...
            sendDeviceNotification(
                ...
                description: textVariableDataFormat(value: translate($pushTips['description']),tipsAmount: $trip->tips),
                status: $push['status'],
                ride_request_id: $trip->id,
                type: $trip->type,
